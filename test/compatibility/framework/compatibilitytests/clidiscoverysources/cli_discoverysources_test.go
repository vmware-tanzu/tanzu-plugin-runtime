...
var _ = ginkgo.Describe("Cross-version CLI Discovery Source APIs Compatibility Tests for supported Runtime versions v0.11.6, v0.25.4, v0.28.0, v0.90.0, latest", func() {
	...
	ginkgo.Context("Run SetCLIDiscoverySource, GetCLIDiscoverySource, GetClientConfig, DeleteCLIDiscoverySource on all supported Runtime library versions latest, v0.90.0, v0.28.0, v0.25.4, v0.11.6", func() {
	...
	ginkgo.Context("Run StoreClientConfig, GetClientConfig, GetCLIDiscoverySource, DeleteCLIDiscoverySource on all supported Runtime library versions latest, v0.90.0, v0.28.0, 0.25.4, 0.11.6", func() {
