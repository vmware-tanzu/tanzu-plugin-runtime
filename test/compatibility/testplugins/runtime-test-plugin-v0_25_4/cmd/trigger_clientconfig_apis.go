...
func triggerGetClientConfigAPI(api *core.API) *core.APIResponse {
	// Trigger GetClientConfig API
	fmt.Printf("Runtime API Name: %v, Runtime Version: %v", api.Name, api.Version)
...
func storeClientConfig(cfg *configapi.ClientConfig) *core.APIResponse {
