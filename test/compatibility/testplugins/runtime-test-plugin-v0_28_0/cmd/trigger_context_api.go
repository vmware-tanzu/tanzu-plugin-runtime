...
func triggerGetCurrentContextAPI(api *core.API) *core.APIResponse {
	...
	return getCurrentContext(cliapi.Target(target))
}
...
func triggerRemoveCurrentContextAPI(api *core.API) *core.APIResponse {
	...
	return removeCurrentContext(cliapi.Target(target))
}
...
func getCurrentContext(target cliapi.Target) *core.APIResponse {
...
func removeCurrentContext(target cliapi.Target) *core.APIResponse {
