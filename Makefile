...
run-compatibility-tests: ## Run Compatibility tests
	cd ./test/compatibility/framework/compatibilitytests && ${GINKGO} --keep-going --fail-fast --race -r --randomize-all --trace --output-dir ./../../../reports --junit-report compatibility-tests.xml; \
