...
var _ = ginkgo.Describe("Cross-version CLI Discovery Source APIs Compatibility Tests for supported Runtime versions v0.11.6, v0.25.4, v0.28.0, latest", func() {
	...
	ginkgo.Context("Run SetCLIDiscoverySource, GetCLIDiscoverySource, GetClientConfig, DeleteCLIDiscoverySource on all supported Runtime library versions latest, v0.28.0, v0.25.4, v0.11.6", func() {
	...
	ginkgo.Context("Run StoreClientConfig, GetClientConfig, GetCLIDiscoverySource, DeleteCLIDiscoverySource on all supported Runtime library versions latest, v0.28.0, 0.25.4, 0.11.6", func() {
		...
		ginkgo.It("Run StoreClientConfig of Runtime v0.28.0 then GetClientConfig, GetCLIDiscoverySource on all supported Runtime library versions and then DeleteCLIDiscoverySource of Runtime latest then GetCLIDiscoverySource on all supported Runtime library versions", func() {
			...
			// Add GetCLIDiscoverySource Commands on all supported Runtime library versions
			testCase.Add(clidiscoverysources.DefaultGetCLIDiscoverySourceCommand(core.Version0280)).Add(clidiscoverysources.DefaultGetCLIDiscoverySourceCommand(core.VersionLatest, clidiscoverysources.WithError(clidiscoverysources.CLIDiscoverySourceNotFound)))
		...
		ginkgo.It("Run StoreClientConfig of Runtime v0.25.4 then GetClientConfig, GetCLIDiscoverySource on all supported Runtime library versions and then DeleteCLIDiscoverySource of Runtime v0.28.0 then GetCLIDiscoverySource on all supported Runtime library versions", func() {
			...
			// Add GetCLIDiscoverySource Commands on all supported Runtime library versions
			testCase.Add(clidiscoverysources.DefaultGetCLIDiscoverySourceCommand(core.VersionLatest, clidiscoverysources.WithError(clidiscoverysources.CLIDiscoverySourceNotFound))).Add(clidiscoverysources.DefaultGetCLIDiscoverySourceCommand(core.Version0280, clidiscoverysources.WithError(clidiscoverysources.CLIDiscoverySourceNotFound)))
