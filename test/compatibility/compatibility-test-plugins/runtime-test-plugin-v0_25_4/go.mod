module github.com/vmware-tanzu/tanzu-plugin-runtime/test/compatibility/compatibility-test-plugins/runtime-test-plugin-v0_25_4
...
require (
	...
	sigs.k8s.io/cluster-api-provider-vsphere v1.3.5 // indirect
