...
replace (
	github.com/vmware-tanzu/tanzu-plugin-runtime/test/compatibility/core => ./test/compatibility/core
	github.com/vmware-tanzu/tanzu-plugin-runtime/test/compatibility/framework => ./test/compatibility/framework
)
