...
// Deprecation targeted for a future version. Superseded by ContextType.
...
const (
	...
	// Deprecation targeted for a future version. Superseded by CtxTypeK8s.
	ManagementClusterServerType ServerType = "managementcluster"

	// GlobalServerType is a global control plane server.
	// Deprecation targeted for a future version. Superseded by CtxTypeTMC.
